//
//  IntravertesFeelingViewController.swift
//  memo
//
...
/*
 1.StoryBoardのクラス名設定
 2.textview関連付け忘れずに
 3.関連付するときの黄色の！マークついてる関連付けは消しておく
 4.@IBActionの関連付け忘れずに
 5.2箇所,カテゴリーの数字変更忘れずに
 */
import UIKit

class IFViewController: UIViewController,UITextViewDelegate {
